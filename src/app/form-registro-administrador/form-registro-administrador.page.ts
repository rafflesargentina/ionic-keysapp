...
@Component({
  ...
  templateUrl: './form-registro-administrador.page.html',
  styleUrls: ['./form-registro-administrador.page.scss'],
})
export class FormRegistroAdministradorPage implements OnInit {
